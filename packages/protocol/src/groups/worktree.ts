...
const root = "/experimental/project/:projectID/worktree"

export class WorktreeError extends Schema.ErrorClass<WorktreeError>("V2WorktreeError")(
  {
